...
public class DriveConstants {
     ...
     * empirically tuned.
     */
    public static double kV = .28168;
    public static double kA = .00281;
    public static double kStatic = .26489;
     ...
     * inches.
     */
    public static double MAX_VEL = ((MAX_RPM)/60.0) * GEAR_RATIO * WHEEL_RADIUS * 2 * Math.PI * .5;
